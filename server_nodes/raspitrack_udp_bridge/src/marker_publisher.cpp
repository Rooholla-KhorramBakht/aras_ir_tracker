...
#include <raspitrack_udp_bridge/ir_markers.h>
...
void *marker_publisher_thread(void *vargp)
{
  ...
  while(nh.ok())
  {
    ...
    raspitrack_udp_bridge::ir_markers ir_markers_msg;
...
int main(int argc, char** argv)
{
  ...
  marker_pub = nh.advertise<raspitrack_udp_bridge::ir_markers>("raspi_tracker/markers", 0);
